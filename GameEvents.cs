...
namespace IslandStranded
{
    internal class GameEvents
    {
        /*
        Part -1
You are flying over the south asia sea.Everything is so blue. Suddenly, the engine stalls...
You are going to crash.In the panic you decide to jump out of the plane with your parachute...
